...
\newcommand{\resumeSubItem}[1]{\item{\textbf{#1}}\vspace{-2pt}}

\newcommand{\resumeSubItemPoint}[1]{
\item{{#1}}\vspace{-2pt}}
...
% Print Heading
%-------------------------------------------
\directlua{printCustomHeading("_data/personal.json")}
...
% Print Projects
%-------------------------------------------
\section{\href{https://github.com/VMMadhavaReddy/}{Projects}}
  \resumeSubHeadingListStart
